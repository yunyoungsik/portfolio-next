...
const desigList = [
  {
    ...
    work: [
      {
        id: 1,
        name: 'MHON.KR Website',
        link: 'mhon',
      },
      {
        id: 2,
        name: 'Converse Promotion Website',
        link: 'converse',
      },
      {
        id: 3,
        name: 'Illionaire Website',
        link: 'illionaire',
      },
      { id: 4, name: 'Illionaire CD Jacket', link: 'illionaireCD' },
      { id: 5, name: 'Interpark Eventpage', link: 'interpark' },
      { id: 6, name: 'Cunhmidang Detailpage', link: 'interpark' },
      { id: 7, name: 'KCSmro Website', link: 'kcsmro' },
      { id: 8, name: 'MinMiCake Website', link: 'minmicake' },
    ],
  },
  {
    id: 1,
  ...
  },
  {
    ...
    work: [
      ...
      },
      {
        id: 3,
        name: 'Business Card',
        link: 'shinwha-businessCard',
      },
      { id: 4, name: 'Name Card', link: 'shinwha-nameCard' },
    ],
  },
];
      ...
      <main id="design">
        <div className="aboutSlideWrap">
          <div className="designTitle">
            <div className="designTitle-item">
              <p>(YunYoungsik)</p>
          ...
          <div className="designContainer">
            <ul className="designWork">
              {desigList.map((item) => (
                <li key={item.id}>
                  <button
                    type="button"
                    className={`designWork-title ${active[item.id] ? 'active' : ''}`}
                  ...
                  <ul className={`workList ${active[item.id] ? 'workOpen' : 'workCloase'}`}>
                    {item.work.map((work) => (
                      <li key={work.id}>
                        <Link href={`/design/${work.link}`} className="underline">
                          {work.name}
                          <svg
                            width="45"
                            height="45"
