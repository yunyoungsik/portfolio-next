    ...
    subLinks.forEach((subLink) => {
        subLink.addEventListener("click", function (event) {
            ...
            const pageTransition = gsap.timeline({
                onComplete: () => {
                    if (subLink.classList.contains("po")) {
                        window.location.href = "./portfolio";
                    } else if (subLink.classList.contains("mh")) {
                        window.location.href = "./mhon";
                    } else if (subLink.classList.contains("fc")) {
                        window.location.href = "./fcon";
                    } else if (subLink.classList.contains("ki")) {
                        window.location.href = "/kickoff";
                    } else if (subLink.classList.contains("td")) {
